 ...
 */
final class Version20230220103641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bookings (id INT AUTO_INCREMENT NOT NULL, product_id_id INT DEFAULT NULL, check_in DATE NOT NULL, check_out DATE NOT NULL, nb_adults INT NOT NULL, nb_kids INT NOT NULL, pool_access_adults INT NOT NULL, pool_access_kids INT NOT NULL, discount NUMERIC(6, 2) NOT NULL, INDEX IDX_7A853C35DE18E50B (product_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
